...
img5 = Image.open(r"models/images/ardha_chakrasana.webp")
img6 = Image.open(r"models/images/Utkatasana.png")
img7 = Image.open(r"models/images/Veerabhadrasan_2.png")
